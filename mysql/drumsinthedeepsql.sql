...
-- Dumping database structure for drumsinthedeep
CREATE DATABASE IF NOT EXISTS `drumsinthedeep` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `drumsinthedeep`;
...
-- Dumping data for table drumsinthedeep.midi_files: ~2 rows (approximately)
...
-- Dumping data for table drumsinthedeep.tracks: ~1 rows (approximately)
...
-- Dumping data for table drumsinthedeep.users: ~0 rows (approximately)
